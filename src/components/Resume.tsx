...
import { GlobalStyle } from "./resume/Styles";
...
const resume: ResumeData = {
  ...
  langAndTech: [
    ...
    "Rust; C; C++; Golang",
    "Python; Perl; Bash",
    "GraphQL; Apache; Ngnix; MySQL; Postgres",
...
type ResumeData = {
  header: ResumeHeader;
  info: ResumeInfo;
  employment: ResumeExperience[];
  education: ResumeExperience[];
  experience: ResumeAddtlExperience[];
  addtlExperience: ResumeAddtlExperience[];
  langAndTech: string[];
};
...
type ResumeAddtlExperience = {
  title: string;
  bullets: ResumeAddtlDetail[];
};

type ResumeAddtlDetail = {
  dates?: string;
  title: string;
  desc: string;
  website: string;
